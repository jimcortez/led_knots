# -*- coding: utf-8 -*-
"""
Vendored from Tweaker-3 by Christoph Schranz et al., licensed GPL-3.0-or-later.

Source: https://github.com/ChristophSchranz/Tweaker-3 (MeshTweaker.py, master, June 2026)

This file is a verbatim copy of the upstream `MeshTweaker.py`, with no source
modifications. It is included here because Tweaker-3 has no PyPI release; we
re-distribute it under GPL-3.0-or-later as a derivative work of the same.

Modifications to this file SHOULD be sent upstream where applicable.

The led-knots project is also licensed GPL-3.0-or-later; see ../../../LICENSE.
"""
import os
import re
import math
