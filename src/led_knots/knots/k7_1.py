"""
K5_1 knot creation using CadQuery.

Creates a k5_1 knot by sweeping an LED circle cross-section
along a mathematical k5_1 knot path generated by pyknotid.
...
This is a 5_1 knot, which is a knot with 5 crossings.
"""

import logging

from pyknotid.spacecurves import Knot
from pyknotid.spacecurves.cutter import TorusKnot
...
def build(config: Config) -> None:
    ...
    k = Knot(TorusKnot.torus_knot_points(p=7, q=2, num_points=200))
