"""
K4_1 knot creation using CadQuery.

Creates a k4_1 knot by sweeping an LED circle cross-section
along a mathematical k4_1 knot path generated by pyknotid.
...
config = get_config(name="K4_1 Knot", description="Create and render a k4_1 knot")
